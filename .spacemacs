...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Operator Mono Lig Book"
                               :size 10.0
                               :weight normal
                               :width normal)
